...
const PLAYERS_AMOUNT = 5;
const BOTS_ONLY = false;
const BOTS_STRATEGIES_POOL = [STRATEGY_NAMES.PRIMITIVE, STRATEGY_NAMES.ALLIN, STRATEGY_NAMES.RANDOM];

// GAME MECHANICS
const PLANET_RANDOM_BREEDING_INFLUENCE = 0.5;
const PLANET_OCCUPIED_BREEDRATE = 2;
const PLANET_NEUTRAL_BREEDRATE = 0.2;

const PLANET_INIT_POPULATION = 50;
const PLANET_NEUTRAL_INIT_POPULATION_MULTIPLIER = 0.5;
